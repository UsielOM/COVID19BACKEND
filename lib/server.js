...
require('../app/Routers/MedicalDataRouters')(app, mariadb);
require('../app/Routers/MedicalCodesRouter')(app, mariadb);
require('../app/Routers/LinkRouters')(app, mariadb);
require('../app/Routers/postSurveyAnswersRouters')(app, mariadb);
require('../app/Routers/AppointmentsRouter')(app, mariadb);
